...
<template>
  <div class="bg-white py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
    <div class="max-w-screen-lg text-gray-800 sm:text-lg">
      <h1 class="text-extrabold text-4xl mb-4">Terms and Conditions of Website Use</h1>
      <p class="mb-4"><em>Last updated July 28, 2024.</em></p>

      <p class="mb-4">Welcome to <a href="https://www.thetoenurse.com" target="_blank">https://www.thetoenurse.com</a>. This website (the "Website") is owned, controlled, and operated by The
        Toe Nurse LLC, a Minnesota limited liability company (sometimes referred to in this document as "we" or "us").
      ...
      <p class="mb-4">In accessing, browsing and/or using any area of the Website, you acknowledge that you have read, understand, and
      ...
      <h2 class="text-extrabold text-3xl mb-4">1. Restrictions on Use of Materials</h2>
      <h3 class="text-extrabold text-2xl mb-4">a. Licensing, Eligibility, and Use of the Website</h3>
      <p class="mb-4">When you provide information to the Website, you agree to provide only true, accurate,
        ...
        current or future use of the Website (or any portion thereof).</p>
      <p class="mb-4">Subject to compliance with these Terms, for a limited time, the Website is granting its users a
      ...
      <p class="mb-4">You understand and agree that the Website is provided "as-is" and that we assume no
        ...
        processes accessible through the Website.</p>
      <p class="mb-4">You also agree that you will not (i) use any robot, spider, rover, scraper, or any other data
        ...
        written consent.</p>
      <p class="mb-4">We will employ reasonable measures to protect the security of users and user information,
        ...
        linked within the Website universe.</p>
      <p class="mb-4">You must be 18 or over, or the legal age to form a binding contract in your jurisdiction if that
        ...
        any local laws applicable to their use of the services or the Website.</p>

      <h3 class="text-extrabold text-2xl mb-4">b. Trademarks</h3>
      <p class="mb-4">The trademarks, service marks, trade names, and logos (collectively "Trademarks") used and
        ...
        endorse your products or services, or (v) in any manner that disparages or discredits us.</p>

      <h3 class="text-extrabold text-2xl mb-4">c. Copyright Notice</h3>
      <p class="mb-4">You acknowledge that the Website contains information, data, software, text, photographs,
        ...
        copyright, or other proprietary right, without obtaining our permission.</p>
      <p class="mb-4">Without limiting the generality of the foregoing, use of any software Company Content shall
        be governed by the service agreement accompanying such software.</p>
      <p class="mb-4">You must receive express written consent from us to use the Website materials for
        ...
        material. This decision will be made at our sole discretion.</p>

      <h3 class="text-extrabold text-2xl mb-4">d. Limited License</h3>
      <p class="mb-4">You may include a text link to any portion of the Website on your website. If you would like
      ...
      <h2 class="text-extrabold text-3xl mb-4">2. Copyright Infringement Policy</h2>
      <p class="mb-4">We have adopted the following general policy toward copyright infringement in accordance with
      ...
      <div class="w-full text-2xl font-extrabold text-center">The Toe Nurse LLC Copyright Infringement Policy</div>

      <p class="mb-4">It is our policy to (a) block access to or remove material that it believes in good faith to be
      ...
      <h3 class="text-extrabold text-2xl mb-4">a. Procedure for Reporting Copyright Infringements.</h3>
      <p class="mb-4">If you believe that material or content residing on or accessible through the Website or the
        ...
        Infringement Notification"):</p>
      <ul class="list-decimal list-inside my-8">
        ...
        <li>Contact information about the notifier including address, telephone number and, if
          available, email address;
        </li>
        <li>A statement that the notifier has a good faith belief that the material is not
          authorized by the copyright owner, its agent, or the law; and
        </li>
        <li>A statement made under penalty of perjury that the information provided is
          accurate and the notifying party is authorized to make the complaint on behalf of
          the copyright owner.
        </li>
      </ul>

      <h3 class="text-extrabold text-2xl mb-4">b. Upon Receipt of a Bona Fide Infringement Notification</h3>
      <p class="mb-4">Once Proper Bona Fide Infringement Notification is received by the Designated Agent, it is
        our policy:</p>
      <ul class="list-decimal list-inside my-8">
        <li>to remove or disable access to the infringing material;</li>
        <li>to notify the content provider, member or user that it has removed or disabled
          access to the material; and
        </li>
        <li>that for repeat offenders, we will also terminate such content provider's, member's
          or user's access to the service.
        </li>
      </ul>

      <h3 class="text-extrabold text-2xl mb-4">c. Procedure to Supply a Counter-Notice to the Designated Agent</h3>
      <p class="mb-4">If the content provider, member or user believes that the material that was removed or to
      ...
      <ul class="list-decimal list-inside my-8">
        ...
        <li>Identification of the material that has been removed or to which access to has been
          disabled and the location at which the material appeared before it was removed or
          disabled;
        </li>
        <li>A statement that the content provider, member or user has a good faith belief that
          the material was removed or disabled as a result of mistake or a misidentification
          of the material; and
        </li>
        <li>The content provider's, member's or user's name, address, telephone number, and, if
      ...
      <h3 class="text-extrabold text-2xl mb-4">d. Removal</h3>
      <p class="mb-4">If a counter-notice is received by the Designated Agent, we may send a copy of the counter-
        ...
        receipt of the counter-notice, at our discretion.</p>

      <h3 class="text-extrabold text-2xl mb-4">e. Address for Designated Agent</h3>
      <p class="mb-4">Please contact our Designated Agent to Receive Notification of Claimed Infringement at the
        following address:</p>

      <p class="mb-4">Copyright Agent, The Toe Nurse LLC<br/>
        172 Gibraltar Rd<br/>
      ...
      <h2 class="text-extrabold text-3xl mb-4">3. Our Proprietary Rights</h2>
      <p class="mb-4">You acknowledge and agree that the Website and any necessary software used in connection with
        ...
        Website.</p>
      <p class="mb-4">Your affirmative act of using this Website and/or registering for the Website or the services
        constitutes your electronic signature to these Terms and your consent to enter into agreements with
        us electronically.</p>

      <h2 class="text-extrabold text-3xl mb-4">4. Representations and Warranties</h2>
      <p class="mb-4">You represent and warrant to us that you will fully comply with these Terms. If you choose to post
      ...
      <h2 class="text-extrabold text-3xl mb-4">5. Indemnification</h2>
      <p class="mb-4">You hereby agree to indemnify, defend and hold us, our affiliated companies, and all officers,
      ...
      <h2 class="text-extrabold text-3xl mb-4">6. Termination</h2>
      <p class="mb-4">You may terminate this license at any time by ceasing to access and use the Website, although you
        ...
        all copies thereof, whether made under these Terms or otherwise.</p>

      <h2 class="text-extrabold text-3xl mb-4">7. DISCLAIMER OF WARRANTIES, LIMITATION OF LIABILITY, AND EXCLUSIONS AND LIMITATIONS</h2>
      <p class="font-extrabold uppercase">THE WEBSITE AND OUR SERVICES ARE PROVIDED BY US ON AN "AS IS" AND "AS
      ...
      <p class="font-extrabold uppercase">UNDER NO CIRCUMSTANCES INCLUDING, BUT NOT LIMITED TO, NEGLIGENCE,
      ...
      <h2 class="text-extrabold text-3xl mb-4">8. Third-Party Content</h2>
      <p class="mb-4">The Website may provide, or third parties may provide, links to other websites or resources.
        ...
        us by third parties.</p>
      <p class="mb-4">Your correspondence or business dealings with, or participation in promotions of, advertisers found
        ...
        such advertisers on the Website.</p>

      <h2 class="text-extrabold text-3xl mb-4">9. Privacy Policy</h2>
      <p class="mb-4">In accordance with the terms of the Website's Privacy Policy, incorporated by reference (available
        at <a href="https://www.thetoenurse.com/privacy" target="_blank">https://www.thetoenurse.com/privacy</a>/privacy), the Website respects your privacy.</p>

      <h2 class="text-extrabold text-3xl mb-4">10. Successors and Assigns</h2>
      <p class="mb-4">These Terms shall be binding upon and inure to the benefit of the parties hereto and their respective
        successors and permitted assigns.</p>

      <h2 class="text-extrabold text-3xl mb-4">11. Construction and Interpretation</h2>
      <p class="mb-4">Headings in these Terms are for ease of reference only and are not to be used to interpret the terms
        and conditions hereof.</p>

      <h2 class="text-extrabold text-3xl mb-4">12. Governing Law</h2>
      <p class="mb-4">These Terms shall be governed by, and construed in accordance with, the laws of Minnesota,
      ...
      <h2 class="text-extrabold text-3xl mb-4">13. Jurisdiction and Venue</h2>
      <p class="mb-4">Each party hereby consents to the jurisdiction of the state and federal courts sitting in Minnesota;
        ...
        in any of such courts.</p>

      <h2 class="text-extrabold text-3xl mb-4">14. Entire Agreement</h2>
      <p class="mb-4">These Terms are intended by the parties as a final expression of their understanding and as a
      ...
      <p class="mb-4">Questions regarding these Terms can be directed to <a href="mailto:privacy@thetoenurse.com">privacy@thetoenurse.com</a>.</p>

      <h2 class="text-extrabold text-3xl mb-4">What to do with your document</h2>
      <p class="mb-4">When you export your document, it will automatically include today's date at the top. Whenever you
        update or review your Terms and Conditions, don't forget to update the date to show your users that it's
        current.</p>
      <p class="mb-4">Post your final document on your website somewhere where users can easily find it, such as a link in
        the footer.</p>
    </div>
  </div>
</template>
